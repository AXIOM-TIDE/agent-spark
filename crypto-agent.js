...
const cryptoConkCitizen = await initConkCitizen('crypto');
...
let agentWallet    = cryptoConkCitizen.address || process.env.CRYPTO_AGENT_WALLET || '0xCRYPTO00000000000000000000000000000000';
