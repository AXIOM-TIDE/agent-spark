...
import { initConkCitizen } from './src/conk/citizenship.js';

const neuralConkCitizen = await initConkCitizen('neural');
...
let agentWallet    = neuralConkCitizen.address || process.env.NEURAL_AGENT_WALLET || '0xNEURAL0000000000000000000000000000000000';
