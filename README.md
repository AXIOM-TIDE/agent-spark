...
## CONK-native architecture

AgentSpark is now the first real consumer of CONK. x402 remains the legacy HTTP payment surface during migration, but the strategic substrate is CONK on Sui.

- Every production service gets a CONK Harbor and Vessel.
- Agent-to-agent communication routes through CONK Casts.
- Agent-to-human communication routes through CONK Flares.
- Settlement and receipts compound through `@axiomtide/conk-sdk`.

See `docs/CONK-Citizenship.md` for the operational contract.
